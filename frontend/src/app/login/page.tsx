...
export default function LoginPage() {
  ...
  const { login, token, error, loading, clearError } = useAuthStore();
    ...
    <div className="min-h-screen bg-[#070b13] text-[#f3f4f6] relative flex flex-col items-center justify-center p-6 selection:bg-blue-500/30 overflow-x-hidden font-sans">
      ...
      >
        <div className="text-center mb-8">
          ...
          <h2 className="text-xl font-semibold mt-4 tracking-tight text-white">Welcome back</h2>
          <p className="text-xs text-gray-400 mt-2 leading-relaxed">Enter your credentials to access your notes</p>
        </div>
        ...
        <p className="text-xs text-gray-400 mt-6 text-center">
          ...
          <Link href="/register" className="text-blue-400 hover:underline font-semibold transition-colors">
            Sign up
          </Link>
        </p>
      </motion.div>
